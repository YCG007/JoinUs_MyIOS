...
- (void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        NSString* url = [NSString stringWithFormat:@"forum/%@", item.id];
...
//        [[[CardData sharedCardData] cards] removeObjectAtIndex:indexPath.row];
//        //        save data存储
//        //                [_myCards writeToFile:[self getlocalFilePath] atomically:YES];
//        
//        [[CardData sharedCardData] save];
